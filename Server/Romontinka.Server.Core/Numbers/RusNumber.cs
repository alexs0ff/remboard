...
namespace Romontinka.Server.Core.Numbers
{
    ...
    public class RusCurrency
    {
        ...
        public static string StrRur(double val)
        {
            return Str(val, "RUR");
        }
        ...
        {
            return Str((double) val).Replace("0", string.Empty).Trim();
        }
            ...
            string juniorOne, string juniorTwo, string juniorFive)
        {
            ...
            var remVal = RusNumber.Str(remainder, false, juniorOne, juniorTwo, juniorFive);
            if (string.IsNullOrWhiteSpace(remVal))
            {
                r.AppendFormat("00 {0}", juniorFive);    
            } //if
