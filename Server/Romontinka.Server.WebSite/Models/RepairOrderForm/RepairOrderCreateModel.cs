...
namespace Romontinka.Server.WebSite.Models.RepairOrderForm
{
    ...
    /// </summary>
    public class RepairOrderCreateModel : JGridDataModelBase<Guid>
    {
        /// <summary>
        ...
        [EditorHtmlClass("order-edit-small")]
        [LabelHtmlClass("order-label-small")]
        [AutocompleteLocalSource("DeviceTrademarkAutocompleteItems", false)]
        ...
        [EditorHtmlClass("order-edit")]
        [LabelHtmlClass("order-label")]
        [AutocompleteLocalSource("DeviceOptionsAutocompleteItems", true)]
        ...
        [EditorHtmlClass("order-edit")]
        [LabelHtmlClass("order-label")]
        [AutocompleteLocalSource("DeviceAppearanceAutocompleteItems", true)]
        ...
        /// </summary>
        [DisplayName("Ориентировочная дата готовности")]
        [EditorHtmlClass("order-edit-small")]
        [LabelHtmlClass("order-label-small")]
        [Required]
