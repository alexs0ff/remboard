...
namespace Remontinka.Client.Wpf.Model.Items
{
    ...
    /// </summary>
    public class RepairOrderEditModel : ViewModelBase<Guid>
    {
        /// <summary>
        /// Задает или получает код статуса заказа.
        /// </summary>
        [DisplayName("Статус заказа")]
        [ComboBoxControl(ControllerType = typeof(OrderStatusController),AllowNull = false,ShowNullValue = true)]
        ...
        /// <summary>
        /// Задает или получает срок гарантии.
        /// </summary>
